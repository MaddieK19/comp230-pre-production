...
*	The animals will:
  *	React to other NPCs
  *	React differently depending on NPC violence  
...
•	It could also be used as the focus of the game if it was a game like ABZU were the animals and interacting with them are a main part of the game.    
•	Could be used in walking simulators, either as a background or a focus in the game.    
•	Target audience would be people   
